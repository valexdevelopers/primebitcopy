...
if(isset($_GET['activate'])){
    ...
    $approvalid = $_GET['activate'];
    
   $sql3 = "UPDATE customers SET status ='active' WHERE cust_id =".$approvalid ;
   if($conn->query($sql3)){
        $p="You have updated the status of an account" ;    
   }else{
       $p="Try Again !" ; 
   }
 ...
 if(isset($_GET['deactivate'])){
    ...
    $approvalid = $_GET['deactivate'];
    
   $sql3 = "UPDATE customers SET status ='inactive' WHERE cust_id =".$approvalid ;
   if($conn->query($sql3)){
        $p="You have updated the status of an account" ;    
   }else{
       $p="Try Again !" ; 
                                ...
                                <div class="bg-icon"><i class="os-icon os-icon-wallet-loaded"></i></div>
                                    ...
                                    <div class="item-media" style="background-image: url(img/avatar3.jpg)"></div><div class="item-name">Kim C<span>olli</span>ns</div></a></div></div></div><div class="search-suggestions-group"><div class="ssg-header"><div class="ssg-icon"><div class="os-icon os-icon-folder"></div></div><div class="ssg-name">Files</div><div class="ssg-info">17 Total</div></div><div class="ssg-content"><div class="ssg-items ssg-items-blocks"><a class="ssg-item" href="#"><div class="item-icon"><i class="os-icon os-icon-file-text"></i></div><div class="item-name">Work<span>Not</span>e.txt</div></a><a class="ssg-item" href="#"><div class="item-icon"><i class="os-icon os-icon-film"></i></div>
                                        <div class="item-name">V<span>ideo</span>.avi</div></a><a class="ssg-item" href="#"><div class="item-icon"><i class="os-icon os-icon-database"></i></div><div class="item-name">User<span>Tabl</span>e.sql</div></a><a class="ssg-item" href="#"><div class="item-icon"><i class="os-icon os-icon-image"></i></div>
                                            <div class="item-name">wed<span>din</span>g.jpg</div></a></div><div class="ssg-nothing-found"><div class="icon-w"><i class="os-icon os-icon-eye-off"></i></div><span>No files were found. Try changing your query...</span></div></div></div></div></div><div class="layout-w"><div class="menu-mobile menu-activated-on-click color-scheme-dark"><div class="mm-logo-buttons-w"><a class="mm-logo" href="index.php"><span>Welcome Back! </span></a><div class="mm-buttons"><div class="content-panel-open"><div class="os-icon os-icon-grid-circles"></div></div><div class="mobile-menu-trigger"><div class="os-icon os-icon-hamburger-menu-1"></div></div></div></div><div class="menu-and-user"><div class="logged-user-w"><div class="avatar-w"><img alt="" src="img/avatarimage.jpg')}}" ></div><div class="logged-user-info-w"><div class="logged-user-name"><?php echo $firstname  ;?>   </div><div class="logged-user-role">Administrator</div></div></div>
                                             <ul class="main-menu">
                                               <li class="selected  ">
                                                    ...
                                                    <li class=" ">
                                                        <a href="https://expertsoption.co/register.php">
                                                            <div class="icon-w">
                                                    ...
                                                    <li class=" ">
                                                        ...
                                                        <div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
                                                            <div class="logged-user-w avatar-inline"><div class="logged-user-i"><div class="avatar-w"><img alt="" src="img/avatarimage.jpg')}}" ></div><div class="logged-user-info-w"><div class="logged-user-name"><?php echo $firstname  ;?>   </div><div class="logged-user-role">Administrator</div></div><div class="logged-user-toggler-arrow"><div class="os-icon os-icon-chevron-down"></div></div><div class="logged-user-menu color-style-bright"><div class="logged-user-avatar-info"><div class="avatar-w"><img alt="" src="img/avatarimage.jpg')}}" ></div><div class="logged-user-info-w"><div class="logged-user-name"><?php echo $firstname  ;?>   </div><div class="logged-user-role">Administrator</div></div></div><div class="bg-icon"><i class="os-icon os-icon-wallet-loaded"></i></div><ul><li><a href="apps_email.html"><i class="os-icon os-icon-mail-01"></i><span>Incoming Mail</span></a></li><li><a href="users_profile_big.html"><i class="os-icon os-icon-user-male-circle2"></i><span>Profile Details</span></a></li><li><a href="users_profile_small.html"><i class="os-icon os-icon-coins-4"></i><span>Billing Details</span></a></li>
                                            ...
                                            <div class="content-w">    
<div class="content-i"><div class="content-box"><div class="element-wrapper"><h6 class="element-header">All registered accounts </h6><div class="element-box"><h5 class="form-header">Accounts Overview</h5><div class="form-desc">All registered accounts are displayed here including their last login time. all account details are as well displayed here for accounts updating and others</div><div class="table-responsive">
    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
        <thead>
            
            <tr><th>Name</th><th>Email</th><th>Country</th><th>Verification</th><th>Status</th><th>Activate</th><th>Deactivate</th></tr></thead>
        <tbody>
            <?php
    $sql4 = "SELECT * FROM customers";
        ...
        ?>
           <tr><td><?php echo $row4["firstname"]." ".$row4["lastname"]; ?> </td><td><?php echo $row4["email"]; ?> </td><td><?php echo $row4["country"]; ?></td><td><?php echo $row4["verification"]; ?></td><td><?php echo $row4["status"]; ?></td><td>
            <a href="deactivate.php?activate=<?=$cus ;?>">Activate</a>
           </td>
           <td><a href="deactivate.php?deactivate=<?=$cus ;?>">Deactivate</a></td></tr>
