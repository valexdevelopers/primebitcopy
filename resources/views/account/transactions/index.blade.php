    ...
    <div class="wrapper-content">
      ...
      <div class="container" style="max-width:1400px">
		...
		<div class="row  align-items-center justify-content-between" style="margin-top:10px">
			...
			<p style="color:white"><b>Transaction History</b></p>
			</div>
		</div>
      ...
      <div class="col-sm-16 col-md-16">
          <div class="card">
              <div class="card-header align-items-start justify-content-between flex">
                  <h4 class="pull-left">Transaction History</h4>
                      ...
                      <div class="scrollmenu">
                          <table cellspacing="400" class="table" table-bordered="">
                              <tbody>
									...
									@if(Auth::user()->deposits->count() > 0)
										@foreach(Auth::user()->deposits as $deposit)
											<tr>
												
												<td>{{ $deposit->type }}</td>
												<td >
													@empty($deposit->paid_amount)
														{{ Auth::user()->currency }} {{ $deposit->initiation_amount  }}
													@else
														{{ Auth::user()->currency }} {{ $deposit->paid_amount  }}
													@endempty
									...
									<tr>
										...
										<td align="center" colspan="4">No data available for this table</td>
									</tr>
